...
\textit{report} or \texttt{open}. Cut is then systematically used
...
and \texttt{cut}ting text, namely the frontpage of yahoo.com.
...
with the encoding- and display of this report.
...
command has been moved to attachments, as it is rather extensive.
\begin{lstlisting}[numbers=none, language={}, frame=single, framexleftmargin={0.2em}]
# cat index.html | grep "yahoo.com"

[output]\ref{att:yahooindex}
\end{lstlisting}
...
The result is further refined by using \texttt{cut} another time.
